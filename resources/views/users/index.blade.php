    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Users List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='users/create'">Add User
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                        ...
                        <tbody>
                         ...
                         <tr>
                          ...
                          <td>
                             <form 
                              method="post" 
                              action="{{route('users.destroy',$role->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
