    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Edit Tenant</h4>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-6 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <input  name="name" value="{{ $vendor->name }}" type="text" class="form-control" placeholder="Name" required="">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label class="text-dark" for="password">Property
                                                  ...
                                                  @foreach($properties as $property)
                                                     ...
                                                     ($vendor->property_id == $property->id ) ? 'selected' : ''
